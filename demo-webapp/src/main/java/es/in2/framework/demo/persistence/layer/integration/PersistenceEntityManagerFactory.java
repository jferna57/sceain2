...
import es.in2.framework.demo.persistence.EntityManagerProxy;
import es.in2.framework.demo.persistence.PersistenceException;
import es.in2.framework.demo.persistence.PersistenceHandler;
import es.in2.framework.demo.util.Constant;
import es.in2.framework.demo.util.config.ConfigurationLoader;
import es.in2.framework.demo.util.layer.integration.GenericFactory;
